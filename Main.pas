...
if not (frmScores = nil) then frmScores.Update(Game, NewOnPos, Feld.Bonus);
end;
...
frmScores.Update(Game,-2, Feld.Bonus);
frmScores.Show;
end;
...
if not (SelectedGame = ActiveGame) then begin
   ...
   NewGame;
   ReadGameType;
   if not (frmScores = nil) then frmScores.Update(Game,-1,Feld.Bonus);
   end;
end;
